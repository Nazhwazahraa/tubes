...
struct kasus daftarKasus[100] = {
    ...
    {3, "Kasus Ferdy Sambo (Brigadir J)", "Terpecahkan", 5, 8, 7, 2022},
    {4, "KM 50 (Laskar FPI)", "Terpecahkan", 4, 1, 10, 2022},
    {5, "Kanjuruhan Tragedi", "Dalam Investigasi", 4, 7, 12, 2020},
    {6, "Kasus Ijazah Palsu Jokowi", "Hoax - Tidak Valid", 1, 1, 9, 2022},
    {7, "Korupsi BTS Kominfo", "Dalam Proses Hukum", 4, 10, 5, 2023},
